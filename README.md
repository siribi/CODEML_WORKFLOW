...
#################################################################################### <br />
CodeML is perhaps not the most easy programs to use, but there are a lot of useful resources out there which can help you get a good idea of how the program works: <br />
...
- Recently Álvarez-Carretero et al. published "A Beginner’s Guide on the Use of PAML to Detect Positive Selection" in Molecular Biology and Evolution. You can find that paper [here](https://academic.oup.com/mbe/article/40/4/msad041/7140562?login=true). <br />
- [A Beginners Guide to Estimating the Non-synonymous to Synonymous Rate Ratio of all Protein-Coding Genes in a Genome](https://www.researchgate.net/publication/268231340_A_Beginners_Guide_to_Estimating_the_Non-synonymous_to_Synonymous_Rate_Ratio_of_all_Protein-Coding_Genes_in_a_Genome) by Jeffares et al. gives a nice introduction on how to use CODEML to Calculate ω and identify positive selection. It also gives a good introduction to the different models of adaptive evolution implemented in CodeML. <br />
- [This tutorial on CodeML by Romain Studer was extremely helpful for me to understand the basics of the branch-site test in CodeML](https://github.com/romainstuder/evosite3d/blob/update_tutorials/tutorials/branchsite.md). I discovered that I had the original tutorial in pdf version and you can find it in the resources folder. <br />
- You can ask questions, search for answers and follow discussions in the [PAML discussion group](https://groups.google.com/g/pamlsoftware) <br />
- The branch-site test is based on the dn/ds ratio. Need a refresher on how dn/ds actually is calculated? You can find a handout from [Searching for Natural Selection: dN/dS](https://www.coursera.org/lecture/genetics-evolution/searching-for-natural-selection-dn-ds-s-6VocF) in the resources folder. <br />
