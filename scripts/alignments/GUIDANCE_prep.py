...
path = '/cluster/home/siribi/work/EVOTREE/CODEML/alignments/FABALES/cds_concat/' #enter directory with backslash at the end

# folder where the new files will be saved to
paths ='/cluster/home/siribi/work/EVOTREE/CODEML/alignments/FABALES/single_copy_orthofasta/' #enter directory with backslash at the end 

# change to directory containing the .fasta file
os.chdir(path)

# filename fasta file
fdna = "Fabales.super.cds"
...
pathi = "/cluster/home/siribi/work/EVOTREE/CODEML/alignments/FABALES/single_copy_index_files/"
