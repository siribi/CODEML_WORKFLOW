...
# A: folder containing the concatenated .fasta file (cds)
path = '/cluster/home/siribi/work/EVOTREE/CODEML/alignments/OXALMALPIGH/cds_concat/' #enter directory with backslash at the end

# B: folder where the new files will be saved to
paths ='/cluster/home/siribi/work/EVOTREE/CODEML/alignments/OXALMALPIGH/single_copy_orthofasta/' #enter directory with backslash at the end 

# change to directory containing the .fasta file
os.chdir(path)

# C: filename fasta file
fdna = "OxalMalpigh.superfasta.cds"
...
# D: OGID.txt files: This path is made by make_files_for_guidance.sbatch (path is $PARENT + single_copy_index_files/ )
pathi = "/cluster/home/siribi/work/EVOTREE/CODEML/alignments/OXALMALPIGH/single_copy_index_files/"
