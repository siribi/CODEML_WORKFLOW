...
# folder containing the concatenated peptide file
path = '/usit/abel/u1/siribi/nobackup/COLD/PIPELINE_RUN_DECEMBER2018/Building_alignments_for_CODEML/draba_MCOGs/pep_files/' #enter directory with backslash at the end

# folder where the new files will be saved to
paths ='/usit/abel/u1/siribi/nobackup/COLD/PIPELINE_RUN_DECEMBER2018/Building_alignments_for_CODEML/draba_MCOGs/orthofasta/' #enter directory with backslash at the end 

# change to directory containing the .fasta file
os.chdir(path)

# filename fasta file
fdna = "CladeB_Draba_concat.pep"
...
# OGID.txt files
pathi = "/usit/abel/u1/siribi/nobackup/COLD/PIPELINE_RUN_DECEMBER2018/Building_alignments_for_CODEML/draba_MCOGs/index_files/"
