seqfile  = REPLACE.pal2nal.phylip 	          * sequence data file name
treefile = Bulk_run_Draba_nemorosa_nobranchlengths.tree 	  * tree structure file name
outfile  = REPLACE.fixed.mlc  	 * main result file name
