seqfile  = REPLACE.pyscript1.phylip 	  * sequence data file name
treefile = Bulk_run_Malpigh.tree  	 * tree structure file name
outfile  = REPLACE.alt.mlc 	 * main result file name
